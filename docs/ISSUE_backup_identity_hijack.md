...
**Не сделано**: разрешение не запрашивается проактивно при первом
запуске/онбординге — только доступно вручную в Profile, пользователь
может не узнать о нём, пока не столкнётся с проблемой (как в этом
случае). Стоит подумать, добавлять ли подсказку при обнаружении
проблем с доставкой. Desktop не тронут — там нет концепции Doze/battery
...
квитанции продолжают уходить после включения тумблера).
